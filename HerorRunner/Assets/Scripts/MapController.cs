...
public class MapController : MonoBehaviour
{
    ...
    void Update()
    {
        foreach (mapObject m in objects)
        { 
            float x = ExtensionMethods.remap(m.obj.transform.position.x,-36f,38.7f,-395f, 395f);
            float y = ExtensionMethods.remap(m.obj.transform.position.z,-41f,33.7f,-355f,355f);
